import os, json, copy, re, zipfile, argparse
...
def analysis(data_path, save_path, save_path_exp):
    compressed_raw_data = {}
    goal_of_dials = {}
    req_slots = {}
    info_slots = {}
...
if __name__ == '__main__':
    ...
    data_path = f'{args.data_folder}/multi-woz/'
    save_path = f'{args.data_folder}/multi-woz-analysis/'
    save_path_exp = f'{args.data_folder}/multi-woz-processed/'

    analysis(data_path=data_path, save_path=save_path, save_path_exp=save_path_exp)
